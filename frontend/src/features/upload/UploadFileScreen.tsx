...
export function UploadFileScreen() {
  ...
  return (
    <section className="tn-page-plain mx-auto flex min-h-[70vh] w-full max-w-2xl flex-col items-center justify-center gap-6 p-6 text-center" aria-labelledby="upload-title">
      <div>
