...
_UPSERT = text(
    ...
    f" invoice_number, irpf_rate, irpf_amount, tax_lines, counterparty_tax_id, counterparty_name, "
    f" own_tax_id_present, "
    ...
    f" :net_amount, :tax_amount, :invoice_number, :irpf_rate, :irpf_amount, "
    f" CAST(:tax_lines AS jsonb), "
    ...
    f" invoice_number = EXCLUDED.invoice_number, irpf_rate = EXCLUDED.irpf_rate, "
    f" irpf_amount = EXCLUDED.irpf_amount, "
