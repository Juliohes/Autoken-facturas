...
_PROTECTED_ROUTES = {
    ...
    ("GET", f"{API}/platform/ocr-ranking/{{engine}}/examples"),
...
def _requests_para_403(dummy_id: str) -> list[tuple[str, str, dict[str, object]]]:
    ...
    return [
        ...
        (
            ...
            {"json": {"counterparty_tax_id": VALID_CIF, "counterparty_name": "X"}},
        ),
        ...
        ("GET", f"{API}/platform/ocr-ranking", {}),
        ("GET", f"{API}/platform/ocr-ranking/gemini-3-flash/examples", {}),
