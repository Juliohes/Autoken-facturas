...
### 🟠 BP-2 — Clasificación de tipos de CIF demasiado laxa — ✅ CERRADO (falso positivo, 2026-06-29; ver `docs/specs/BP-2-clasificacion-control-cif.md`)
...
### 🟠 BP-3 — Service-locator en vez de inyección de dependencias — ✅ CERRADO (2026-06-29; ver `docs/specs/BP-3-health-inyeccion-settings.md`)
...
### 🟡 BP-4 — Validadores no defienden contra `None` — ✅ CERRADO (2026-06-30; ver `docs/specs/BP-4-validadores-defienden-none.md`)
...
### 🟡 BP-5 — `log_level: str` traga valores inválidos en silencio — ✅ CERRADO (2026-06-30; ver `docs/specs/BP-5-log-level-fail-loud.md`)
